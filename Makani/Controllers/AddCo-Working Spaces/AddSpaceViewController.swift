...
//        }
      ...
      let secondAddSpaceVc = storyboard?.instantiateViewController(withIdentifier: "AddSpaceSecondScreenViewController") as! AddSpaceSecondScreenViewController
          secondAddSpaceVc.spaceName = spaceName
          secondAddSpaceVc.numberPhone = numberPhone
          secondAddSpaceVc.country = country
          secondAddSpaceVc.government =  government
          secondAddSpaceVc.spaceAddress = spaceAddress
          secondAddSpaceVc.email =  email
          secondAddSpaceVc.website = website
